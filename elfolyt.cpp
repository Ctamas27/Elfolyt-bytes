...
protected:			// ha esetleg egyszer majd kiterjesztjük az osztályt, mert
    ...
    Csomopont * gyoker; //csomopont class-ba a gyoker ennek egy objektuma
    int maxMelyseg;
    double atlag, szoras;
...
//Csomopont*gyoker (csak egy pointert tartalmazzon a gyokerre)"attol hogy ez elpusztul, a masik meg eljen"
